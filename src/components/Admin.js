    ...
    <div>
      ...
      <p>
        {isAdmin
          ...
          : `Only Website Administrators should have access to this page`}
      </p>
      <div hidden={isAdmin ? false : true}>
        <button className="admin-view-button" onClick={showProducts}>
          View Products
        </button>
        <button className="admin-view-button" onClick={showUsers}>
          View Users
        </button>
        {/* ***************** USERS VIEW *****************    */}

        <TableContainer component={Paper} hidden={!usersView}>
          <Table
            sx={{ minWidth: 900 }}
        ...
        {/* ***************** PRODUCTS VIEW *****************    */}
        <TableContainer component={Paper} hidden={!productsView}>
          <button
                ...
                <TableBody key={idx}>
                  <TableRow>
                    ...
                    <TableCell>
                      ...
                      />
                      <p hidden={!viewDescription}>{product.description}</p>
                    </TableCell>
